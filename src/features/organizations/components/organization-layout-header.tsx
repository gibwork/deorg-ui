...
const NavigationItems = [
  ...
  {
    label: "Documentation",
    href: "/organizations/documentation",
    icon: Book,
  },
];
  ...
  return (
    <div className="flex items-center justify-between p-4 ">
      <Popover>
        ...
        <PopoverContent
          className="PopoverContent ms-4 rounded-lg pt-2"
          sideOffset={5}
        >
          <div>
                ...
                <ul className="flex flex-col gap-2 mt-2">
                  {NavigationItems.map((item) => (
                    <Link href={item.href} key={item.href}>
                      <li
                        className={cn(
                          "text-sm text-black font-medium inline-flex items-center px-2 py-1 rounded-md cursor-pointer hover:bg-stone-100",
                          pathname === item.href && "bg-stone-100"
                        )}
                      >
...
export default OrganizationLayoutHeader;
