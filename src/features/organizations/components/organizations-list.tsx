        ...
        <div className="mx-auto w-full max-w-screen-lg flex items-center gap-5 ">
          <div className="flex justify-between">
            <div className="w-full sm:w-2/4 p-4 mt-10">
              <h1 className="text-3xl font-bold">Where Token Communities Thrive</h1>
              <p className="text-gray-500 mt-4">
                DeOrg makes it easy to create, manage, and grow your token community with <span className="font-medium text-black">actionable governance</span>.
              </p>
              <Link href="/organizations/create" className={cn(buttonVariants({ variant: "default", className: "mt-4" }))}>
        ...
        <div className="container">
          ...
          <div className="flex flex-col mb-8  mt-10">
            ...
            <div className="flex flex-row gap-2 mt-4">
              <Badge variant="default" className="rounded-sm bg-stone-200 px-4 text-stone-600 hover:bg-stone-100 gap-1 text-lg">Explore</Badge>
              {isSignedIn && (
                <Badge variant="default" className="rounded-sm bg-stone-50 px-4 text-stone-600 hover:bg-stone-100 gap-1 text-lg">Yours</Badge>
              )}
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">
                        {org.name.length >= 30 ? org.name.substring(0, org.name.length - 30).toUpperCase() : org.name}
                      </h3>
